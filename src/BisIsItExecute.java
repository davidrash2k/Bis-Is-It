...
public class BisIsItExecute {
	
	private BisIsItGUI gui;
	public BisIsItExecute(BisIsItGUI gui){
		this.gui = gui;
	}
	
	public void executeProgram(){
	
	String filename = BisIsItLang.filename;
	BisLexer lexer2 = null;
	try {
		lexer2 = new BisLexer ( new ANTLRFileStream(filename));
	...
	BisLexer lexer = null;
	try {
		lexer = new BisLexer(new ANTLRFileStream(filename));
	} catch (IOException e1) {
		// TODO Auto-generated catch block
		e1.printStackTrace();
	}
